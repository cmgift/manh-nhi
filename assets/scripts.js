...
if (!window["Heartlove"]) {
  window.Heartlove = {
    data: {
      messages: ["Chúc em luôn vui vẻ", "Mãi yêu em", "Thật sự yêu em rất nhiều đó"],
      images: [],
      heartColor: "#FF1493",
    },
  };
    ...
    try {
      ...
      window["Heartlove"] = {
        data: {
          messages: a.messages || [],
          images: a["images"] || [],
          heartColor: a["heartColor"] || "#FF1493",
          music: a["music"] || null,
        },
      };
...
const heartInitialColor = new THREE["Color"](
  useCustomColor ? appData.heartColor : "#FF1493"
);
let imageTextures = [];
